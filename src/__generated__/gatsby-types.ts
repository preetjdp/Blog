...
type Unnamed_1_Query = { readonly switchOnSound: Maybe<Pick<File, 'publicURL'>>, readonly switchOffSound: Maybe<Pick<File, 'publicURL'>> };
...
type Unnamed_4_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
