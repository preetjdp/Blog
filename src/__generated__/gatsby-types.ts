...
type dProductsBlogsrcpages404Js3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type dProductsBlogsrcpages404Js3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type dProductsBlogsrcpagesindexTsx871773079QueryVariables = Exact<{ [key: string]: never; }>;


type dProductsBlogsrcpagesindexTsx871773079Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
...
type dProductsBlogsrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type dProductsBlogsrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
...
type dProductsBlogsrccomponentsseoTsx2039842131QueryVariables = Exact<{ [key: string]: never; }>;


type dProductsBlogsrccomponentsseoTsx2039842131Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
...
type dProductsBlogsrccomponentsToggleTsx4245473236QueryVariables = Exact<{ [key: string]: never; }>;


type dProductsBlogsrccomponentsToggleTsx4245473236Query = { readonly switchOnSound: Maybe<Pick<File, 'publicURL'>>, readonly switchOffSound: Maybe<Pick<File, 'publicURL'>> };
